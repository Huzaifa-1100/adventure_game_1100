...
export class Player {
  ...
  fuelDecrease() {
    ...
    console.log(
      chalk.bgWhite.green(`\t\t${opponent1.name} fuel is ${opponent1.fuel}`)
    );
    console.log("-".repeat(50));
  }
  ...
  energyDrink() {
    ...
    console.log(
      chalk.bgWhite.green(
        `\t${player1.name} your fuel is increase by 10% Fuel is : ${player1.fuel}`
      )
    );
  }
  ...
  medicine() {
    ...
    console.log(
      chalk.bgWhite.green(
        `\t${player1.name} your fuel is increase by 30% Fuel is : ${player1.fuel}`
      )
    );
  }
  // Method to 100 % fuel
  firstAidKit() {
    this.fuel = 100;
    console.log(
      chalk.bgWhite.green(`\t${player1.name} your fuel is : ${player1.fuel}`)
    );
  }
}
