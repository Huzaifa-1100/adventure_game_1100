...
while (true) {
  ...
  switch (players.opponent) {
    ...
    case "Vampire":
      ...
      console.log(
        chalk.bgWhite.black(
          `\t\t${chalk.green(players.playerName)} V/S ${chalk.red(
            players.opponent
          )}`
        )
      );
      ...
      if (askUser.select === "Healing") {
        ...
        if (askHeal.heal === "Energy Drink") {
          if (player1.fuel < 100) {
            ...
            console.log(
              chalk.bgWhite.green("Your fuel is full Please try again later")
            );
          }
        }
        if (askHeal.heal === "Medicine") {
          if (player1.fuel <= 70) {
            ...
            console.log(
              chalk.bgRed(
                `Your Fuel is 70+ you can try another Heal Options like Energy Drink`
              )
            );
          }
        }
